...
**Актуальность выбора темы:** в настоящее время многие страховые компании используют в своей работе программное обеспечение, и ошибка в работе этих программ может принести большие неудобства пользователей и финансовые затраты самой компании. Поэтому разработчикам и тестировщикам программного обеспечения необходимо уделять много времени и ресурсов тестированию этих программ.
**Тема проекта:** Исследование особенностей организации процесса ручного тестирования веб-приложения на примере тестирования сайта ведущей страховой компании Республики Беларусь – БРУСП Белгосстрах (далее Белгосстрах).
Дипломная работа посвящена подготовке и реализации конечного набора тестов, который должен покрывать поставленные требования, проверять модуль на корректность работы с точки заданного алгоритма функционирования и исключать появление программных ошибок, которые блокируют работу программы.
**Цель проекта:** Изучить особенности ручного тестирования веб-приложения в условиях наличия Технического задания к программному модулю «Личный кабинет» и разработать предложения по улучшению организации процесса ручного тестирования. Обеспечить проверку соответствия программного обеспечения предъявляемым требованиям, а также обеспечить уверенность в качестве программного обеспечения, поиск очевидных ошибок в программном обеспечении.

**Задачи проекта:**
1. Изучить Техническое задание модуля «Личный кабинет».
2. Рассмотреть основные виды и методы ручного тестирования веб-приложений.
3. Ознакомиться с основными принципами составления тестовой документации: тест-кейсы, баг-репорты.
4. Составить план ручного тестирования веб-приложения Белгосстрах модуля «Личный кабинет» с использованием техник тест-дизайна.
5. Выполнить ручное тестирование веб-приложения Белгосстрах модуля «Личный кабинет».
6. Разработать предложения по улучшению ручного тестирования веб-приложения Белгосстрах модуля «Личный кабинет».
Инструменты: Qase.io, Jira, DevTools, Git, GitHub, Postman.
...
![Что входит в функциональное тестирование](https://test-planet.by/wp-content/uploads/2018/08/funkcionalnoe.png)

Виды функционального тестирования:
![Функциональное тестирование](https://testengineer.ru/wp-content/uploads/2023/02/%D0%A2%D0%B8%D0%BF%D1%8B-%D1%84%D1%83%D0%BD%D0%BA%D1%86%D0%B8%D0%BE%D0%BD%D0%B0%D0%BB%D1%8C%D0%BD%D0%BE%D0%B3%D0%BE-%D1%82%D0%B5%D1%81%D1%82%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D1%8F-1024x1024.png) 
...
![Методы по доступу к коду](https://test-planet.by/wp-content/uploads/2018/08/cherny-yashchik.png)
...
**1. Эквивалентное разбитие (Equivalence partitioning)**
...
**3. Анализ доменов (Domain analysis)**
...
**4. Тестирование всех пар (All pairs testing, Pairwise)**
...
**5. Тестирование таблицы решений (Decision table testing)**
...
**6. Тестирование диаграммы переходов состояний (State transition testing)**
...
**7. Тестирование сценариев использования (Use Case Testing)**
...
**8. Тестирование историй использования (User Story Testing)**
*Пользовательские истории* - это описание требований к системе на языке пользователя (с его точки зрения). Вроде звучит понятно, но суть еще не ясна? Погрузимся поглубже.
...
**1. Тестирование покрытия операторов (Statement testing and coverage)**
...
**2. Тестирование покрытия условий и решений (Decision testing and coverage)**
...
*Метод покрытия условий*. Лучшие результаты по сравнению с предыдущими методами может дать метод покрытия условий. В этом случае записывается число тестов, достаточное для того, чтобы все возможные результаты каждого условия в решении выполнялись по крайней мере один раз.

**3. Тестирования покрытия условий и значений операторов (The value of statement and decision testing)**
...
**1. Предугадывание ошибок (Error guessing)**
...
**3. Иисследовательское тестирование (Ad-hoc testing)**
...
**4. Тестирование по чек-листам (Checklist-based testing)**
...
##5. МОДЕЛИ ПРОЦЕССА РАЗРАБОТКИ ПРОГРАММНОГО ОБЕСПЕЧЕНИЯ
...
![Waterfall](https://uploads.hb.cldmail.ru/geekbrains/public/ckeditor_assets/pictures/4759/content-2ef30b24595d40b0755dba3a699cca6e.png)
...
В современной разработке наибольшей популярностью пользуется целое семейство методологий - **Agile** - это гибкий подход к управлению проектами по разработке программного обеспечения (ПО), который часто применяют в небольших командах.
...
![Agile](https://synergy.ru/assets/upload/news/academy/81.1_kopiya.png)
...
**Роли в Скраме:**
![Роли в Скраме](https://skademy.by/wp-content/uploads/2021/04/scrum_hrpr_manageit_3.jpg)
...
![Kanban board](https://web-static.wrike.com/cdn-cgi/image/width=900,format=auto/blog/content/uploads/2019/01/Scrum_vs_Kanban_Board_Building_Project_Plan_1.jpg?av=67178aaef730cdcf4557eb016a3da830)
...
Если посмотреть на происходящее на страховом рынке применительно к продуктовой линейке, то становится очевидным, что запросы клиентов по обслуживанию стремятся к режиму «ON-LINE». Ключевым фактором успеха страховой компании является беспрепятственный, автоматизированный комплексный клиентский опыт, который без особых усилий удовлетворяет индивидуальные потребности пользователей. 

Использование изучаемых моделей являются важнейшими критериями для увеличения объемов on-line страховых сделок. Именно по этой причине объектами тестирования в данной работе были выбраны модули «Вход пользователя» и «Регистрация нового пользователя» (Приложение___)

##7.2. СОСТАВЛЕНИЕ ТЕСТ-КЕЙСОВ С УЧЕТОМ ПОКРЫТИЯ ТРЕБОВАНИЙ

Проанализировав Техническое задание страховой компании Белгосстрах, были составлены тесты и сформированы тестовые сценарии, которые содержат позитивные и негативные проверки.
...
Для проведения качественного тестирования были разработаны тест-кейсы на основе имеющихся спецификаций, используя метод «Черного ящика». 

Тестовый сценарий включает в себя 5 тестовых наборов:
1. Отображение данных на экране, содержит в себе 9 тест-кейсов;
2. Ввод тестовых данных в форме "Вход в систему" - 4 тест-кейса;
3. Ввод тестовых данных в форме "Регистрация пользователя" - 5 тест-кейсов;
4. Ввод тестовых данных в форме "Персональные данные" - 6 тест-кейсов;
5. Ввод тестовых данных в форме "Паспортные данные" - 4 тест-кейса; 

Все созданные тест-кейсы находятся по нижеуказанной ссылке: 
[Ссылка на тест-кейсы](https://docs.google.com/spreadsheets/d/1hi6yUI9Q2WfkkdDeqQaDh0KxI1fRa7Cm/edit#gid=1715125718)
...
![Линейные классы эквивалентности](images/%D0%B4%D0%BE%D0%BC%D0%B5%D0%BD%D0%BD%D1%8B%D0%B9%201.png)
...
![Нелинейные классы эквивалентности](images/%D0%B4%D0%BE%D0%BC%D0%B5%D0%BD%D0%BD%D1%8B%D0%B9%202.png)
...
![Регистрация](images/%D1%80%D0%B5%D0%B3%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8F.png)

Регистрация пользователя прошла успешно:
![Успешная регистрация](images/%D1%80%D0%B5%D0%B3%D0%B8%D1%81%D1%82%D1%80%D0%B0%D1%86%D0%B8%D1%8F%20%D1%83%D1%81%D0%BF%D0%B5%D1%88%D0%BD%D0%BE.png)

2. Теперь войдем в «Личный кабинет», как зарегистрированный пользователь, протестируем форму «Вход в систему»:

![Вход в систему](images/%D0%B2%D1%85%D0%BE%D0%B4.png)

Вход в систему, зарегистрированного пользователя прошел успешно:

![Успешный вход](images/%D0%B4%D0%BE%D0%B1%D1%80%D0%BE%20%D0%BF%D0%BE%D0%B6%D0%B0%D0%BB%D0%BE%D0%B2%D0%B0%D1%82%D1%8C.png)
...
19 тест-кейсов – на проверку вводимых данных.
...
**Цель доменного тестирования** — предоставить стратегию по выбору минимального набора показательных тестов. Методика базируется и обобщает методы эквивалентного разбиения и анализа граничных значений.
Т.к. тестировались несколько параметров одновременно, применили метод Доменного анализа, с помощью которого было сформировано 93 теста:
...
![Доменный анализ](images/%D0%B4%D0%BE%D0%BC1.png)
...
![Pairwise](images/%D0%BF%D0%B0%D1%801.png)
...
![Доменный анализ](images/%D0%B4%D0%BE%D0%BC2.png)

![Pairwise](images/%D0%BF%D0%B0%D1%802.png)
...
![Доменный анализ](images/%D0%B4%D0%BE%D0%BC3.png)

![Pairwise](images/%D0%BF%D0%B0%D1%803.png)
...
![Вход в систему](images/%D1%8E%D0%B11.png)
...
2. Форма «Регистрация»:
После регистрации, пользователь попадает на страницу, где предлагается изучить Инструкцию для регистрации. Перейдя в личные сообщения, пользователь видит сообщение, где указывается о том, что нужно кликнуть пиктограмму:

![Инструкция](images/%D1%8E%D0%B12.png)
...
![](images/%D0%BB%D0%BE%D0%BA2.png)

При переходе в Личный кабинет при выборе ENG отображается страница, где полностью весь блок информации для пользователя остался на русском языке, при чем иконка выбора языка неактивна (не подсвечивается):
![](images/%D0%BB%D0%BE%D0%BA3.png)
...
1. 
2. Виды Тестирования [Электронный ресурс]/ Про Тестинг - Тестирование Программного Обеспечения. RL: http://www.protesting.ru/testing/types/sanity.html 
3. Канер С., Фолк Дж., Енг Кек Нгуен. Тестирование программного обеспечения: Фундаментальные концепции менеджмента бизнес-приложений
4. Котляров В. П., Коликова Т. В. Основы тестирования программного обеспечения
5. Гленфорд Майерс, Том Баджетт, Кори Сандлер  “Искусство тестирования программ”
6. Д. Уиттакер, Д. Арбон, Д. Каролло «Как тестируют в Google»
7. Основные положения тестирования [Электронный ресурс]/ Интересные публикации / Хабрахабр. URL: https://habrahabr.ru/post/110307/
8. Рекс Блек. Ключевые процессы тестирования - М.: Издательство Лори, 2014. - 544 с.
9. Савин Роман. Тестирование DOT COM. Издательство Дело, 2007.
10. С. Куликов «Тестирование программного обеспечения. Базовый курс»
11. Тамре Л. Введение в тестирование программного обеспечения
...
![](images/%D0%A2%D0%971.png)

При вводе невалидной почты при клике на «Войти» появляется тултип с ошибкой красного цвета «Ошибка при проверке данных пользователя. Неверное имя пользователя или пароль». Максимально допустимая длина поля 30 символов.
...
![](images/%D0%A2%D0%976.png)

В поле «Область/Регион» из выпадающего списка выбрать область/регион.
В поле «Район области» из выпадающего списка выбрать район.
В полях «Населенный пункт» выбрать из выпадающего списка: тип населенного пункта, наименование населенного пункта, тип улицы. В поле названия улицы ввести наименование улицы. При введении первой буквы появляется выпадающий список улиц населенного пункта.
В поле «Дом» необходимо ввести номер дома. Допускаются буквы, цифры и спецсимволы.
В поле «Корпус» необходимо ввести номер дома. Допускаются буквы, цифры и спецсимволы.
В поле «Помещение» необходимо выбрать из выпадающего списка тип помещения.
В поле «Номер помещения» необходимо ввести номер помещения. Допускаются буквы, цифры и спецсимволы.
При не заполнении обязательных полей, ниже появляется мигающее, красного цвета, сообщение: «Невозможно сохранить адрес, т.к. не заполнены все обязательные поля».
При клике на кнопку «ОК» происходит редактирование адреса и перенаправление на форму «Персональные данные». Активная вкладка подсвечивается: фон #D5DFF2.
Если в форме «Персональные данные» не заполнено какое-либо поле, система выдает ошибку: Во вкладке "Персональные данные" не заполнено поле "Фамилия"

ВКЛАДКА ПАСПОРТНЫЕ ДАННЫЕ 
![](images/%D0%A2%D0%977.png)
...
В поле «Кем выдан» необходимо ввести данные кем выдан документ. Максимальная длина - 50 символов. Допускаются буквы (кириллица), цифры, спецсимволы, пробел. Поле содержит плейсхолдер.
При клике на поле «Дата выдачи (дд.мм.гггг)» открывается календарь для выбора даты. Выбранная дата отражается в формате дд.мм.гггг. Есть возможность ввести дату вручную в формате дд.мм.гггг. Допускается ввод цифр, спецсимволов.
При клике на поле «Действителен до (дд.мм.гггг)» открывается календарь для выбора даты. Выбранная дата отражается в формате дд.мм.гггг. Есть возможность ввести дату вручную в формате дд.мм.гггг. Допускается ввод цифр, спецсимволов.
